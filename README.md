...
1. Copy [brightbeacon-sdk-1.0.6.jar](https://github.com/BrightBeacon/BrightBeacon_Android_SDK/blob/master/BrightSDK/brightbeacon-sdk-1.0.6.jar) to your `libs` directory.
