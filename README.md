...
1. Copy [brightbeacon-sdk-1.0.8.jar](https://github.com/BrightBeacon/BrightBeacon_Android_SDK/blob/master/BrightSDK/brightbeacon-sdk-1.0.8.jar) to your `libs` directory.
